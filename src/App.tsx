...
export default function App() {
  ...
  const { tickets, setTickets, assets, setAssets, purchases, setPurchases } = useAppStore();
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-10 custom-scrollbar">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === "tickets" && <TicketsModule searchTerm={searchTerm} isAdmin={isAdmin} />}
              {activeTab === "assets" && <AssetsModule searchTerm={searchTerm} isAdmin={isAdmin} />}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="enterprise-card p-6">
            ...
            <div className="h-[300px] w-full min-h-[300px] min-w-[1px]">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="enterprise-card p-6">
            ...
            <div className="h-[250px] w-full min-h-[250px] min-w-[1px] mt-4">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="enterprise-card p-6">
            ...
            <div className="relative h-[250px] min-h-[250px] min-w-[1px] flex items-center justify-center">
              <ResponsiveContainer width="100%" height="100%">
                <RePieChart>
                  <Pie
                    data={pieData}
