...
REVOKE EXECUTE ON FUNCTION public.guard_app_users_privilege_escalation() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.sync_user_name_to_asset_records() FROM PUBLIC, anon, authenticated;
